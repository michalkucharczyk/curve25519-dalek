...
use super::field::FieldElement4x64;
...
pub(crate) const MINUS_ONE: FieldElement4x64 = FieldElement4x64::from_limbs([
    0xffffffffffffffec,
    0xffffffffffffffff,
    0xffffffffffffffff,
    0x7fffffffffffffff,
...
pub(crate) const EDWARDS_D: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x75eb4dca135978a3,
    0x00700a4d4141d8ab,
    0x8cc740797779e898,
    0x52036cee2b6ffe73,
...
pub(crate) const EDWARDS_D2: FieldElement4x64 = FieldElement4x64::from_limbs([
    0xebd69b9426b2f159,
    0x00e0149a8283b156,
    0x198e80f2eef3d130,
    0x2406d9dc56dffce7,
...
pub(crate) const ONE_MINUS_EDWARDS_D_SQUARED: FieldElement4x64 = FieldElement4x64::from_limbs([
    0xe27c09c1945fc176,
    0x2c81a138cd5e350f,
    0x9994abddbe70dfe4,
    0x029072a8b2b3e0d7,
...
pub(crate) const EDWARDS_D_MINUS_ONE_SQUARED: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x31ad5aaa44ed4d20,
    0xd29e4a2cb01e1999,
    0x4cdcd32f529b4eeb,
    0x5968b37af66c2241,
...
pub(crate) const SQRT_AD_MINUS_ONE: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x7e97f6a0497b2e1b,
    0xaf9d8e0c1b7854bd,
    0x0f3cfcc931f5d1fd,
    0x376931bf2b8348ac,
...
pub(crate) const INVSQRT_A_MINUS_D: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x99c8fdaa805d40ea,
    0x9d2f16175a4172be,
    0x16c27b91fe01d840,
    0x786c8905cfaffca2,
...
pub(crate) const SQRT_M1: FieldElement4x64 = FieldElement4x64::from_limbs([
    0xc4ee1b274a0ea0b0,
    0x2f431806ad2fe478,
    0x2b4d00993dfbd7a7,
    0x2b8324804fc1df0b,
...
pub(crate) const APLUS2_OVER_FOUR: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x000000000001db42,
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
...
/// Elligator map.)
pub(crate) const MONTGOMERY_A: FieldElement4x64 = FieldElement4x64::from_limbs([
    0x0000000000076d06,
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
...
/// Elligator map.)
pub(crate) const MONTGOMERY_A_NEG: FieldElement4x64 = FieldElement4x64::from_limbs([
    0xfffffffffff892e7,
    0xffffffffffffffff,
    0xffffffffffffffff,
    0x7fffffffffffffff,
...
pub const ED25519_BASEPOINT_POINT: EdwardsPoint = EdwardsPoint {
    X: FieldElement4x64::from_limbs([
        0xc9562d608f25d51a,
        0x692cc7609525a7b2,
        0xc0a4e231fdd6dc5c,
        0x216936d3cd6e53fe,
    ]),
    Y: FieldElement4x64::from_limbs([
        0x6666666666666658,
        0x6666666666666666,
        0x6666666666666666,
        0x6666666666666666,
    ]),
    Z: FieldElement4x64::from_limbs([
        0x0000000000000001,
        0x0000000000000000,
        0x0000000000000000,
        0x0000000000000000,
    ]),
    T: FieldElement4x64::from_limbs([
        0x6dde8ab3a5b7dda3,
        0x20f09f80775152f5,
        0x66ea4e8e64abe37d,
        0x67875f0fd78b7665,
...
static ED25519_BASEPOINT_TABLE_INNER_DOC_HIDDEN: EdwardsBasepointTable = EdwardsBasepointTable([
    LookupTable([
        AffineNielsPoint {
            y_plus_x: FieldElement4x64::from_limbs([
                0x2fbc93c6f58c3b72,
                0xcf932dc6fb8c0e19,
                0x270b4898643d42c2,
                0x87cf9d3a33d4ba65,
            ]),
            y_minus_x: FieldElement4x64::from_limbs([
                0x9d103905d740913e,
                0xfd399f05d140beb3,
                0xa5c18434688f8a09,
                0x44fd2f9298f81267,
            ]),
            xy2d: FieldElement4x64::from_limbs([
                0xabc91205877aaa68,
                0x26d9e823ccaac49e,
                0x5a1b7dcbdd43598c,
                0x6f117b689f0c65a8,
